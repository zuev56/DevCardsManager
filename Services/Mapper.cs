...
internal static class Mapper
{
    ...
    public static Settings ToSettings(this IList<ParameterViewModel> parameters, List<string> pinnedCards, List<LogItemPattern> patternsToRemove, List<LogItemPattern> patternsToLeave)
    {
        ...
        var settings = new Settings
        {
            ...
            ShowInsertCardOnTimeButton = ((BooleanParameterViewModel)parameters.Single(p => p.PropertyName == nameof(Settings.ShowInsertCardOnTimeButton))).Value,
            InsertCardOnTimeMs = ((IntegerParameterViewModel)parameters.Single(p => p.PropertyName == nameof(Settings.InsertCardOnTimeMs))).Value,
            ShowCardInfoButton = ((BooleanParameterViewModel)parameters.Single(p => p.PropertyName == nameof(Settings.ShowCardInfoButton))).Value,
            ShowCardUid = ((BooleanParameterViewModel)parameters.Single(p => p.PropertyName == nameof(Settings.ShowCardUid))).Value,
